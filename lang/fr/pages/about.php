...
return [
    ...
    'career' => [
        ...
        'steps' => [
            '1' => [
                'job' => 'CESS – Orientation Sciences naturelles / Biotecnhiques',
                'location' => 'INDSE Bastogne',
                'year' => '2023',
            ],
            '2' => [
                'job' => 'Bachelier Techniques infographiques orientation web / multimédia',
                'location' => 'HEPL',
                'year' => '2023 – 2026',
            ],
            '3' => [
                'job' => 'Développeur Front-End – Stage en entreprise',
                'location' => 'Léonard Web Solutions',
                'year' => '2026',
                'months' => 'Janvier – Avril'
            ],
        ]
    ],
    'commitment' => [
        ...
        'list' => [
            '1' => [
                'title' => 'Site optimisé et performant',
                'description' => 'Je m’engage à optimiser votre site pour une navigation fluide tout en appliquant les meilleures pratiques en matière de SEO.',
            ],
            '2' => [
