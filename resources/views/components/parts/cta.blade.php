...
<div class="screen-width grid-default px-default py-default">
    <div
        ...
        <h2 class="max-md:[&>br]:hidden text-h3 text-black font-medium text-center md:col-start-3 md:col-span-4 rl:col-start-4 rl:col-span-6">{!! $cta['title'] !!}</h2>
        <p class="text-p text-gray-dark text-center md:col-start-3 md:col-span-4 rl:col-start-5 rl:col-span-4">{!! $cta['text'] !!}</p>
