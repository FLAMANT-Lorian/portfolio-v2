...
<a wire:navigate
   ...
   @endif
   class="hover:font-semibold hover:text-red ease-all before:w-0 before:h-0 before:content-[''] before:block before:bg-white md:before:bg-red flex flex-row items-center gap-0 text-h3 md:text-p text-white md:text-gray-dark">
    {{ $label }}
</a>
